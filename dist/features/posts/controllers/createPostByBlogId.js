...
exports.createPostById = void 0;
const sharedTypes_1 = require("../../../types/sharedTypes");
const postService_1 = require("../services/postService");
const postQueryRepo_1 = require("../repositories/postQueryRepo");
const createPostById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const postId = yield postService_1.postService.createPostByBlog(req.params.id, req.body);
        ...
        if (error instanceof sharedTypes_1.Error404)
            ...
            console.error(`Cannot create post with blogid: ${error.message}`);
            res.sendStatus(500);
        }
    }
});
