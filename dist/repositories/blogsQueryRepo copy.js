...
exports.blogsQueryRepo = {
    getMany(query) {
        return __awaiter(this, void 0, void 0, function* () {
            const searchByName = query.searchNameTerm ? { name: new RegExp(query.searchNameTerm, 'i') } : {};
            const allBlogs = yield mongo_db_1.blogsCollection
                ...
                .toArray();
            const totalCount = yield mongo_db_1.blogsCollection.countDocuments(searchByName);
